...
//////////
//Mostrar los links por cada entrevista respondida
//////////
...
//si está mirando la entrevista inicial, mostrar el link
                    if(strtolower($this->survey->name) == "entrevista inicial"){
                        ...
                        get_string('response', 'questionnaire').($i + 1).'</a>'.'&nbsp;&nbsp;&nbsp;'.'<a title = "Imprimir entrevista" href="entrevista/entrevista.php?rid='.$rids[$i].'&amp;action=list" target="_blank" >Imprimir</a> &nbsp;');
                    }else
                    {
                        array_push($linkarr, '<a title = "'.$responsedate.'" href="'.$url.'&amp;rid='.
                        $rids[$i].'&amp;individualresponse=1" >'.
